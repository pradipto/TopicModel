...
class CCorrTagSquaredLDA : public CCorrTagSquaredLDAGeneralModel {

protected:

	friend class CCorrTagSquaredLDAEMFunctionoid;
	/*!
...
protected:
	...
	std::vector<std::vector<double>* >* _beta_ms_term1;	// this is the first term for the topic-word parameter (ms = marginal statistic)
	...
	SCorrTagSquaredLDACorpus* _corpus;
...
public:
	...
	inline SCorrTagSquaredLDACorpus* get_corpus() { return _corpus; }
	 ...
	 *
	 */
	virtual void set_bytecode(std::string bytecode) { CCorrTagSquaredLDAGeneralModel::_bytecode = bytecode; }
	/**
	 *
	 */
	 ...
	 *
	 */
	virtual void set_model_dump_mode(std::string model_dump_mode) { CCorrTagSquaredLDAGeneralModel::_model_dump_mode = model_dump_mode; }
	/**
	 *
	 */
	virtual void set_model_operation_mode(std::string model_operation_mode) { CCorrTagSquaredLDAGeneralModel::_model_operation_mode = model_operation_mode; }
	/**
	 *
	 */
	virtual std::string get_model_operation_mode() { return CCorrTagSquaredLDAGeneralModel::_model_operation_mode; }
	/**
	 *
	 */
	virtual std::string get_model_dump_mode() { return CCorrTagSquaredLDAGeneralModel::_model_dump_mode; }
	/**
	 *
	 */
	...
	virtual inline std::string to_string() {
		if ( CCorrTagSquaredLDAGeneralModel::_model_operation_mode == "train" ) return "CorrTagSquaredLDA-train";
		if ( CCorrTagSquaredLDAGeneralModel::_model_operation_mode == "test" || CCorrTagSquaredLDAGeneralModel::_model_operation_mode == "validate" ) return "CorrTagSquaredLDA-test";
		return "CorrTagSquaredLDA-EM";	// returns this std::string by default
	}
	/**
	 *
	 */
...
private:
	 ...
	 *
	 */
	double compute_doc_log_likelihood(size_t doc_id, SCorrTagSquaredLDADocument* doc);
