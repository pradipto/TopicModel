/**
 *  file CCorrTagSquaredLDAGeneralModel.h
 *
 *  Created on: May 21, 2010
 *      Author: pdas
 */

#ifndef CCORRTAGSQUAREDLDAGENERALMODEL_H_
#define CCORRTAGSQUAREDLDAGENERALMODEL_H_

#include "../Utilities/includes.h"
#include "AGraphicalModel.h"
#include "../DataSet/CorrTagSquaredLDADataset.h"
 ...
 * The public methods in this base class CCorrTagSquaredLDAGeneralModel opens up the API for accessing the model
 * data structures
 *
 * @see AGraphicalModel

 */
class CCorrTagSquaredLDAGeneralModel : public AGraphicalModel{
...
public:
	 ...
	 * @see CCorrTagSquaredLDAGeneralModel::_bytecode
	 ...
	 */
	CCorrTagSquaredLDAGeneralModel() { _model_dump_mode = "text"; }
	/**
	 * @brief virtual destructor for CCorrTagSquaredLDAGeneralModel
	 */
	virtual ~CCorrTagSquaredLDAGeneralModel() {}
	 ...
	 * @see CCorrTagSquaredLDAGeneralModel::_model_dump_mode
	 *
	 ...
	 * @see CCorrTagSquaredLDAGeneralModel::_model_operation_mode
	 *
	...
	/**
	 * @brief returns the value of the std::string _model_operation_mode
	 * @see CCorrTagSquaredLDAGeneralModel::_model_operation_mode
	 * @return the value of the std::string _model_operation_mode
	 */
	 ...
	 * @see SCorpus
	 */
	virtual SCorrTagSquaredLDACorpus* get_corpus() { return 0; }
	/**
...
#endif /* CCORRTAGSQUAREDLDAGENERALMODEL_H_ */
