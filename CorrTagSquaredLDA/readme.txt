...
$> bin/CorrTagSquaredLDA _config_files/sample-train-config-cikm11AR-20.txt train

===== INFERENCE =====
$> bin/CorrTagSquaredLDA _config_files/sample-test-config-cikm11AR-20.txt test
