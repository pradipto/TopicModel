/**
 *  file CTagLDAGeneralModel.h
 *
 *  Created on: May 21, 2010
 *      Author: pdas
 */

#ifndef CTagLDAGeneralMODEL_H_
#define CTagLDAGeneralMODEL_H_
 ...
 * The public methods in this base class CTagLDAGeneralModel opens up the API for accessing the model
 * data structures
 *
 * @see AGraphicalModel

 */
class CTagLDAGeneralModel : public AGraphicalModel{
...
public:
	 ...
	 * @see CTagLDAGeneralModel::_bytecode
	 ...
	 */
	CTagLDAGeneralModel() { _model_dump_mode = "text"; }
	/**
	 * @brief virtual destructor for CTagLDAGeneralModel
	 */
	virtual ~CTagLDAGeneralModel() {}
	 ...
	 * @see CTagLDAGeneralModel::_model_dump_mode
	 *
	 ...
	 * @see CTagLDAGeneralModel::_model_operation_mode
	 *
	 ...
	 * @see SCorpus
	 */
	virtual STagLDACorpus* get_corpus() { return 0; }
	/**
