...
#ifndef CorrLDADATASET_H_
#define CorrLDADATASET_H_
...
struct SCorrLDADocument {
	...
	/*!
	 * @brief the stl::std::vector representing the counts of the corresponding feature ids in a document
	 */
...
struct SCorrLDACorpus {
	 ...
	 */
	SCorrLDACorpus() {
		_document_vec = new std::vector<SCorrLDADocument*>();
		_n_docs = 0;
