...
#include "../GraphicalModels/CCorrLDA.h"

class CCorrLDA;
class CCorrLDAGeneralModel;

class CCorrLDAEMFunctionoid: public CModelEMFunctionoid {

	CCorrLDA* _model;
	CCorrLDAGeneralModel* _base_model;

	double _model_log_likelihood;

public:
	CCorrLDAEMFunctionoid();
	virtual ~CCorrLDAEMFunctionoid();
...
public:
	 ...
	 *
	 */
	virtual inline CCorrLDAGeneralModel* get_concrete_model() { return _base_model; }
	/**
	 *
	 */
...
private:
	 ...
	 */
	virtual double doc_expectation_step(size_t doc_id, SCorrLDADocument* doc);
	/**
