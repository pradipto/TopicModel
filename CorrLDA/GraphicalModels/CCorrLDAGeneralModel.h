/**
 *  file CCorrLDAGeneralModel.h
 *
 *  Created on: May 21, 2010
 *      Author: pdas
 */

#ifndef CCORRLDAGENERALMODEL_H_
#define CCORRLDAGENERALMODEL_H_

#include "../Utilities/includes.h"
#include "AGraphicalModel.h"
#include "../DataSet/CorrLDADataset.h"
 ...
 * The public methods in this base class CCorrLDAGeneralModel opens up the API for accessing the model
 * data structures
 *
 * @see AGraphicalModel

 */
class CCorrLDAGeneralModel : public AGraphicalModel{
...
public:
	 ...
	 * @see CCorrLDAGeneralModel::_bytecode
	...
	/**
	 * @brief This function returns the model bytecode which is a std::string
	 * @see CCorrLDAGeneralModel::_bytecode
	 * @return the model bytecode which is a std::string
	 */
	 ...
	 */
	CCorrLDAGeneralModel() { _model_dump_mode = "text"; }
	/**
	 * @brief virtual destructor for CCorrLDAGeneralModel
	 */
	virtual ~CCorrLDAGeneralModel() {}
	...
	/**
	 * @brief This function sets the value of the std::string member variable _model_dump_mode
	 *
	...
	/**
	 * @brief returns the model_dump_mode  which is a std::string
	 * @see CCorrLDAGeneralModel::_model_dump_mode
	 *
	 * @return the model_dump_mode  which is a std::string
	 */
	 ...
	 * @see CCorrLDAGeneralModel::_operation_mode
	 *
	 * @param model_operation_mode is the mode represented as a std::string in which the model operates. \n
	 * The value can only be "train" or "test"
	 */
	virtual void set_model_operation_mode(std::string model_operation_mode) { _operation_mode = model_operation_mode; }
	/**
	 * @brief returns the value of the std::string _operation_mode
	 * @see CCorrLDAGeneralModel::_operation_mode
	 * @return the value of the std::string _operation_mode
	 */
	virtual std::string get_model_operation_mode() { return _operation_mode; }
	...
	/**
	 * @return an std::string representing, possibly, the name of the model
	 */
	 ...
	 * @brief returns a pointer to a std::vector of std::vector pointers:\n
	 * The number of rows equals the number of latent topics in the model.\n
	 * The number of columns equals the number of corr datum in the training corpus.\n
	 *
	 * @return a pointer to a std::vector of std::vector pointers.\n
	 * The number of rows equals the number of latent topics in the model.\n
	 * The number of columns equals the number of corr datum in the training corpus.\n
	 ...
	 *
	 */
	virtual std::vector<std::vector<double>* >* get_topic_feature_multinomials() { return 0; }
	/**
	 * @brief This function returns the std::string filename that corresponds to a text file of datum ids to datum labels.\n
	 ...
	 *
	 * @return the std::string filename that corresponds to a text file of datum ids to datum labels.
	 */
	virtual std::string get_datum_to_id_dictionary_filename() { return "no dictionary filename from base class"; }
	/**
	 * @brief returns the std::string filename that corresponds to the file where the topic_datum multinomials are written
	 *
	 * @return the std::string filename that corresponds to the file where the topic_datum multinomials are written
	 *
	 ...
	 * @see SCorpus
	 */
	virtual SCorrLDACorpus* get_corpus() { return 0; }
	/**
