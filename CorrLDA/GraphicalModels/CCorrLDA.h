...
#include "CCorrLDAGeneralModel.h"
...
class CCorrLDA : public CCorrLDAGeneralModel {

protected:

	friend class CCorrLDAEMFunctionoid;
	/*!
...
public:
	...
	inline SCorrLDACorpus* get_corpus() { return _corpus; }
	 ...
	 *
	 */
	virtual void set_bytecode(std::string bytecode) { CCorrLDAGeneralModel::_bytecode = bytecode; }
	/**
	 *
	 */
	 ...
	 *
	 */
	virtual void set_model_dump_mode(std::string model_dump_mode) { CCorrLDAGeneralModel::_model_dump_mode = model_dump_mode; }
	/**
	 *
	 */
	virtual void set_model_operation_mode(std::string model_operation_mode) { CCorrLDAGeneralModel::_operation_mode = model_operation_mode; }
	/**
	 *
	 */
	virtual std::string get_model_operation_mode() { return CCorrLDAGeneralModel::_operation_mode; }
	/**
	 *
	 */
	virtual std::string get_model_dump_mode() { return CCorrLDAGeneralModel::_model_dump_mode; }
	/**
	 *
	 */
	...
	virtual inline std::string to_string() {
		if ( CCorrLDAGeneralModel::_operation_mode == "train" ) return "CorrLDA-train";
		if ( CCorrLDAGeneralModel::_operation_mode == "test" || CCorrLDAGeneralModel::_operation_mode == "validate" ) return "CorrLDA-test";
		if ( CCorrLDAGeneralModel::_operation_mode == "predict" ) return "TagLDA-predict";
		return "CorrLDA-EM";	// returns this std::string by default
	}
	/**
	 *
	 */
...
private:
	 ...
	 *
	 */
	double compute_doc_log_likelihood(size_t doc_id, SCorrLDADocument* doc);
