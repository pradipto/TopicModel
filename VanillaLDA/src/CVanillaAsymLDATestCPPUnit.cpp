/*
 * CVanillaAsymLDATestCPPUnit.cpp
 *
...
CVanillaAsymLDATestCPPUnit::CVanillaAsymLDATestCPPUnit(string model_description_file, string model_compiled_file, string config_file) {
...
CVanillaAsymLDATestCPPUnit::~CVanillaAsymLDATestCPPUnit() {
