...
public:
	 ...
	 *
	 */
	virtual inline CVanillaAsymLDAGeneralModel* get_concrete_model() { if (b_verbose_global) std::cout << "You should derive your own C<YourModel>EMFunctionoid from CModelEMFunctionoid" << std::endl; return 0; }
	/**
	 *
	 */
