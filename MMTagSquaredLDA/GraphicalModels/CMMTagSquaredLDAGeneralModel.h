/**
 *  file CMMTagSquaredLDAGeneralModel.h
 *
 *  Created on: May 21, 2010
 *      Author: pdas
 */

#ifndef CMMTAGSQUAREDLDAGENERALMODEL_H_
#define CMMTAGSQUAREDLDAGENERALMODEL_H_
 ...
 * The public methods in this base class CMMTagSquaredLDAGeneralModel opens up the API for accessing the model
 * data structures
 *
 * @see AGraphicalModel

 */
class CMMTagSquaredLDAGeneralModel : public AGraphicalModel{
...
public:
	 ...
	 * @see CMMTagSquaredLDAGeneralModel::_bytecode
	 ...
	 */
	CMMTagSquaredLDAGeneralModel() { _model_dump_mode = "text"; }
	/**
	 * @brief virtual destructor for CMMTagSquaredLDAGeneralModel
	 */
	virtual ~CMMTagSquaredLDAGeneralModel() {}
	 ...
	 * @see CMMTagSquaredLDAGeneralModel::_model_dump_mode
	 *
	 ...
	 * @see CMMTagSquaredLDAGeneralModel::_model_operation_mode
	 *
	 ...
	 * @see SCorpus
	 */
	virtual SMMTagSquaredLDACorpus* get_corpus() { return 0; }
	/**
...
#endif /* CMMTAGSQUAREDLDAGENERALMODEL_H_ */
