...
#ifndef MMTAGSQUAREDLDADATASET_H_
#define MMTAGSQUAREDLDADATASET_H_
 ...
 */
struct SMMTagSquaredLDADocument {
...
struct SMMTagSquaredLDACorpus {
	 ...
	 */
	SMMTagSquaredLDACorpus() {
		_document_vec = new std::vector<SMMTagSquaredLDADocument*>();
		_n_docs = 0;
...
#endif /* MMTAGSQUAREDLDADATASET_H_ */
