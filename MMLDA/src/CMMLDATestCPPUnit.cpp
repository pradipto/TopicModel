...
CMMLDATestCPPUnit::CMMLDATestCPPUnit(string model_description_file, string model_compiled_file, string config_file) {
...
CMMLDATestCPPUnit::~CMMLDATestCPPUnit() {
