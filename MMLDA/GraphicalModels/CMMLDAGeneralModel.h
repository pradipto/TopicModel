/**
 *  file CMMLDAGeneralModel.h
 *
 *  Created on: May 21, 2010
 *      Author: pdas
 */

#ifndef CMMLDAGENERALMODEL_H_
#define CMMLDAGENERALMODEL_H_
 ...
 * The public methods in this base class CMMLDAGeneralModel opens up the API for accessing the model
 * data structures
 *
 * @see AGraphicalModel

 */
class CMMLDAGeneralModel : public AGraphicalModel{
...
public:
	 ...
	 * @see CMMLDAGeneralModel::_bytecode
	 ...
	 */
	CMMLDAGeneralModel() { _model_dump_mode = "text"; }
	/**
	 * @brief virtual destructor for CMMLDAGeneralModel
	 */
	virtual ~CMMLDAGeneralModel() {}
	 ...
	 * @see CMMLDAGeneralModel::_model_dump_mode
	 *
	 ...
	 * @see CMMLDAGeneralModel::_operation_mode
	 *
	 ...
	 * @see SCorpus
	 */
	virtual SMMLDACorpus* get_corpus() { return 0; }
	/**
