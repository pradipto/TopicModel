...
#ifndef MMLDADATASET_H_
#define MMLDADATASET_H_
...
struct SMMLDACorpus {
	 ...
	 */
	std::vector<SMMLDADocument*> *_document_vec;
	/*!
	 ...
	 */
	SMMLDACorpus() {
		_document_vec = new std::vector<SMMLDADocument*>();
		_n_docs = 0;
